...
<div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-600 to-purple-700 py-12 px-4 sm:px-6 lg:px-8">
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-indigo-200">Enter your admin credentials</p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-2xl overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-indigo-600 to-purple-600 px-6 py-4">
                <h2 class="text-xl font-semibold text-white">Administrator Login</h2>
            </div>
                ...
                <form method="POST" action="<?php echo e(route('admin.login.submit')); ?>" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input id="email" 
                               ...
                               autocomplete="email" 
                               required
                               value="<?php echo e(old('email', '77mojid77@gmail.com')); ?>"
                               class="block w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-sm"
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mt-6 bg-white/10 backdrop-blur-sm rounded-lg p-4 border border-white/20">
            ...
            <div class="space-y-2 text-sm text-white/90">
                <p><span class="font-medium">Email:</span> 77mojid77@gmail.com</p>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\habib\Downloads\laravel-ecom\laravel-ecom\resources\views/admin-login.blade.php ENDPATH**/ ?>