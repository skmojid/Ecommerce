...
<div class="max-w-6xl mx-auto">
    ...
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="<?php echo e(route('admin.categories.create')); ?>" class="bg-indigo-600 text-white px-4 py-2 rounded-lg hover:bg-indigo-700 transition-colors">
                    ...
                    <div class="bg-white border border-gray-200 rounded-xl p-4 hover:shadow-lg transition-shadow duration-200">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600 mb-4">
                                <?php echo e(Str::limit($category->description ?? 'No description available', 100)); ?>
                            ...
                            <div class="grid grid-cols-2 gap-4 text-sm">
                                <div>
                                    ...
                                    <span class="font-semibold text-gray-900"><?php echo e($category->products_count ?? 0); ?></span>
                                </div>
                                <div>
                                    <span class="text-gray-500">Sort Order:</span>
                                    <span class="font-semibold text-gray-900"><?php echo e($category->sort_order ?? 0); ?></span>
                                </div>
                            </div>
                        </div>
                ...
                <div class="flex items-center justify-between mt-6 pt-6 border-t border-gray-200">
                    ...
                    <div class="flex items-center space-x-2">
                        @when($categories->currentPage > 1, function ($page) use ($categories) {
                            <a href="<?php echo e($categories->previousPageUrl($page)); ?>" 
                        ...
                        <span class="px-4 py-2 text-sm text-gray-700">
                            Page <?php echo e($categories->currentPage()); ?>

                        </span>
                        
                        @when($categories->currentPage < $categories->lastPage(), function ($page) use ($categories) {
                            <a href="<?php echo e($categories->nextPageUrl($page)); ?>" 
                               class="relative inline-flex items-center px-3 py-2 text-sm font-medium text-gray-500 bg-white border border-gray-300 rounded-lg hover:bg-gray-50">
                                Next
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\habib\Downloads\laravel-ecom\laravel-ecom\resources\views/admin/categories/index.blade.php ENDPATH**/ ?>