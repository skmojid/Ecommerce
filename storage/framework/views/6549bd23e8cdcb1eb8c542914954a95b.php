        ...
        <div class="flex justify-between items-center h-16 py-2">
            ...
            <div class="hidden lg:flex items-center space-x-8">
                ...
                <div class="relative group">
                    ...
                    <a href="<?php echo e(route('shop.index')); ?>" class="block px-4 py-3 text-sm text-gray-700 hover:bg-green-50 hover:text-green-600 rounded-xl transition-all duration-200 mb-1">
                        <i class="fas fa-store mr-3 text-green-500"></i>All Products
                    </a>
                    <a href="<?php echo e(route('shop.categories.index')); ?>" class="block px-4 py-3 text-sm text-gray-700 hover:bg-green-50 hover:text-green-600 rounded-xl transition-all duration-200 mb-1">
                        <i class="fas fa-th-large mr-3 text-green-500"></i>Browse Categories
                    </a>
                    <a href="<?php echo e(route('shop.search')); ?>" class="block px-4 py-3 text-sm text-gray-700 hover:bg-green-50 hover:text-green-600 rounded-xl transition-all duration-200">
                    ...
                    <div class="absolute left-0 mt-3 w-72 bg-white rounded-2xl shadow-2xl border border-gray-100 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 transform group-hover:translate-y-0 translate-y-2">
                        <div class="p-4">
                            ...
                            <div class="grid grid-cols-2 gap-2">
                                <a href="<?php echo e(route('shop.categories.index')); ?>" class="block px-4 py-3 text-sm text-gray-700 hover:bg-green-50 hover:text-green-600 rounded-xl transition-all duration-200">
            ...
            <div class="flex items-center space-x-3">
                ...
                <a href="<?php echo e(route('cart.index')); ?>" class="relative group p-2.5 rounded-full hover:bg-green-50 transition-all duration-300" title="Shopping Cart">
                ...
                <?php if(auth()->guard()->guest()): ?>
                    <a href="<?php echo e(route('login')); ?>" class="hidden sm:flex items-center px-4 py-2.5 text-sm font-medium text-gray-700 hover:text-green-600 hover:bg-green-50 rounded-full transition-all duration-300">
                        <i class="fas fa-user mr-2"></i>Login
                    </a>
                    <a href="<?php echo e(route('register')); ?>" class="flex items-center px-5 py-2.5 bg-gradient-to-r from-green-600 to-green-700 text-white text-sm font-medium rounded-full hover:from-green-700 hover:to-green-800 transition-all duration-300 shadow-md hover:shadow-green-200">
                        ...
                        <div class="absolute right-0 mt-3 w-64 bg-white rounded-2xl shadow-2xl border border-gray-100 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 transform group-hover:translate-y-0 translate-y-2">
                            <div class="p-4">
                                ...
                                <div class="pt-3 space-y-1">
                                    <a href="<?php echo e(route('profile')); ?>" class="block px-4 py-2.5 text-sm text-gray-700 hover:bg-green-50 hover:text-green-600 rounded-xl transition-all duration-200">
                                        <i class="fas fa-user-circle mr-3 text-green-500"></i>My Profile
                                    </a>
                                    <a href="<?php echo e(route('customer.orders.index')); ?>" class="block px-4 py-2.5 text-sm text-gray-700 hover:bg-green-50 hover:text-green-600 rounded-xl transition-all duration-200">
                                        <i class="fas fa-box mr-3 text-green-500"></i>My Orders
                                    </a>
                                    <a href="<?php echo e(route('customer.account.index')); ?>" class="block px-4 py-2.5 text-sm text-gray-700 hover:bg-green-50 hover:text-green-600 rounded-xl transition-all duration-200">
                                        <i class="fas fa-cog mr-3 text-green-500"></i>Account Settings
                                    </a>
                                    
                                    <?php if(Auth::user()->isAdmin() || Auth::user()->isManager()): ?>
                                        <div class="border-t border-gray-100 my-2"></div>
                                        <a href="<?php echo e(route('admin.dashboard')); ?>" class="block px-4 py-2.5 text-sm text-green-600 hover:bg-green-50 rounded-xl transition-all duration-200 font-medium">
            ...
            <div class="px-4 py-4 space-y-3">
                ...
                <?php else: ?>
                    <a href="<?php echo e(route('profile')); ?>" class="mobile-nav-link">
                        <i class="fas fa-user mr-3 text-green-500"></i><?php echo e(Auth::user()->name); ?>
                    ...
                    <?php if(Auth::user()->isAdmin() || Auth::user()->isManager()): ?>
                        <a href="<?php echo e(route('admin.dashboard')); ?>" class="mobile-nav-link text-green-600 font-medium">
                            <i class="fas fa-tachometer-alt mr-3"></i>Admin Panel
                        </a>
                    <?php endif; ?>
                    <form action="<?php echo e(route('logout')); ?>" method="POST" class="block">
...
<?php /**PATH C:\Users\habib\Downloads\Ecommerce-main\Ecommerce-main\resources\views/layouts/navbar.blade.php ENDPATH**/ ?>