    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div class="text-center">
            ...
            <p class="text-xl text-indigo-100" data-items-count>
                <?php echo e($cart->items->count()); ?> <?php echo e(Str::plural('item', $cart->items->count())); ?> in your cart
            </p>
        </div>
    </div>
</section>
                        ...
                        <div class="divide-y divide-gray-200">
                            <?php $__currentLoopData = $cart->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if(!$item->product): ?>
                                    ...
                                    <?php continue; ?>
                                <?php endif; ?>
                                <div class="p-6" data-item-id="<?php echo e($item->id); ?>">
                                    <div class="flex items-center space-x-4">
                                        ...
                                        <div class="flex-1">
                                            <h3 class="text-lg font-medium text-gray-900">
                                                <?php if($item->product): ?>
                                                    <a href="<?php echo e(route('shop.show', $item->product)); ?>" class="hover:text-indigo-600">
                                            ...
                                            <p class="text-sm text-gray-500">
                                                <?php echo e($item->product->category->name ?? ($item->product ? 'Uncategorized' : 'Product Not Available')); ?>

                                            </p>
                                            <?php if($item->variation_id): ?>
                                                <p class="text-sm text-indigo-600">Variant: <?php echo e($item->variation->name ?? 'N/A'); ?></p>
                                            <?php endif; ?>
                                        ...
                                        <div class="flex items-center space-x-2">
                                            <div class="flex items-center space-x-2">
                                                <input type="hidden" name="product_id_<?php echo e($item->id); ?>" value="<?php echo e($item->product_id); ?>">
                                                
                                                <button type="button" onclick="updateCartItem(<?php echo e($item->id); ?>, <?php echo e($item->quantity - 1); ?>)"
                                                ...
                                                <input type="number" id="quantity-<?php echo e($item->id); ?>" 
                                        ...
                                        <div class="text-right">
                                            <p class="text-lg font-semibold text-gray-900" data-item-price="<?php echo e($item->id); ?>">
                                                $<?php echo e(number_format($item->total_price, 2)); ?>

                                            </p>
                                            <button type="button" onclick="removeCartItem(<?php echo e($item->id); ?>)" class="text-red-600 hover:text-red-800 text-sm">
                    ...
                    <div class="bg-white rounded-lg shadow-md overflow-hidden sticky top-4">
                        ...
                        <div class="p-6 space-y-4">
                            <div class="flex justify-between text-gray-600">
                                <span>Subtotal (<span data-items-count><?php echo e($cart->items->count()); ?></span> items)</span>
                                <span data-subtotal>$<?php echo e(number_format($cart->subtotal ?? 0, 2)); ?></span>
                            </div>
                            
                            <div class="flex justify-between text-gray-600">
                                <span>Shipping</span>
                                <span data-shipping>$<?php echo e(number_format($cart->shipping_amount ?? 0, 2)); ?></span>
                            </div>
                            
                            <div class="flex justify-between text-gray-600">
                                <span>Tax</span>
                                <span data-tax>$<?php echo e(number_format($cart->tax_amount ?? 0, 2)); ?></span>
                            </div>
                            ...
                            <div class="border-t border-gray-200 pt-4">
                                <div class="flex justify-between text-xl font-semibold text-gray-900">
                                    <span>Total</span>
                                    <span data-total>$<?php echo e(number_format($cart->total ?? 0, 2)); ?></span>
                                </div>
                            </div>
...
function updateCartTotals() {
    fetch('<?php echo e(route("cart.totals")); ?>')
        .then(response => response.json())
        .then(data => {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\habib\Downloads\Ecommerce-main\Ecommerce-main\resources\views/shop/cart/index.blade.php ENDPATH**/ ?>