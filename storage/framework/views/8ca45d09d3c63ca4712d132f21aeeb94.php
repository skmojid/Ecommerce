    ...
    <div class="stat-card bg-white rounded-xl shadow-sm border border-gray-200 p-6 relative overflow-hidden">
        ...
        <div class="flex items-center justify-between relative">
            <div>
                ...
                <p class="text-3xl font-bold text-gray-900 mt-2">$<?php echo e(number_format($stats['total_revenue'] ?? 45231, 2)); ?></p>
            </div>
    ...
    <div class="stat-card bg-white rounded-xl shadow-sm border border-gray-200 p-6 relative overflow-hidden">
        ...
        <div class="flex items-center justify-between relative">
            <div>
                ...
                <p class="text-3xl font-bold text-gray-900 mt-2"><?php echo e(number_format($stats['total_orders'] ?? 1234)); ?></p>
            </div>
    ...
    <div class="stat-card bg-white rounded-xl shadow-sm border border-gray-200 p-6 relative overflow-hidden">
        ...
        <div class="flex items-center justify-between relative">
            <div>
                ...
                <p class="text-3xl font-bold text-gray-900 mt-2"><?php echo e(number_format($stats['total_products'] ?? 456)); ?></p>
            </div>
