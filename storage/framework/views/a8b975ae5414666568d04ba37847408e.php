    ...
    <div class="stat-card bg-gradient-to-br from-white to-emerald-50 rounded-2xl shadow-lg border border-emerald-100 p-6 relative overflow-hidden group">
        ...
        <div class="flex items-center justify-between relative">
            <div>
                ...
                <p class="text-3xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent mt-2">$<?php echo e(number_format($stats['total_revenue'] ?? 45231, 2)); ?></p>
            </div>
    ...
    <div class="stat-card bg-gradient-to-br from-white to-blue-50 rounded-2xl shadow-lg border border-blue-100 p-6 relative overflow-hidden group">
        ...
        <div class="flex items-center justify-between relative">
            <div>
                ...
                <p class="text-3xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent mt-2"><?php echo e(number_format($stats['total_orders'] ?? 1234)); ?></p>
            </div>
    ...
    <div class="stat-card bg-gradient-to-br from-white to-purple-50 rounded-2xl shadow-lg border border-purple-100 p-6 relative overflow-hidden group">
        ...
        <div class="flex items-center justify-between relative">
            <div>
                ...
                <p class="text-3xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent mt-2"><?php echo e(number_format($stats['total_customers'] ?? 0)); ?></p>
            </div>
    ...
    <div class="stat-card bg-gradient-to-br from-white to-orange-50 rounded-2xl shadow-lg border border-orange-100 p-6 relative overflow-hidden group">
        ...
        <div class="flex items-center justify-between relative">
            <div>
                ...
                <p class="text-3xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent mt-2"><?php echo e(number_format($stats['total_products'] ?? 456)); ?></p>
            </div>
...
<!-- Recent Orders -->
    <div class="lg:col-span-2 bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <div class="flex items-center justify-between mb-6">
            ...
            <a href="<?php echo e(route('admin.orders.index')); ?>" class="text-sm text-indigo-600 hover:text-indigo-800 font-medium">View all</a>
        </div>
                    ...
                    <tbody class="divide-y divide-gray-200">
                        <?php $__currentLoopData = $recentOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-gray-50 transition-colors">
                                <td class="py-3 px-4 text-sm text-gray-900 font-medium">#<?php echo e($order->id); ?></td>
                                <td class="py-3 px-4">
                                    <div class="flex items-center">
                                        ...
                                        <div class="text-gray-900"><?php echo e($order->user->name ?? 'Guest'); ?></div>
                                    </td>
                                <td class="py-3 px-4 text-sm text-gray-500"><?php echo e($order->items->count()); ?> items</td>
                                <td class="py-3 px-4 text-sm text-gray-900">$<?php echo e(number_format($order->total, 2)); ?></td>
                                ...
                                <td class="py-3 px-4 whitespace-nowrap"><?php echo e($order->created_at->format('M d, Y')); ?></td>
                            </tr>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\habib\Downloads\Ecommerce-main\Ecommerce-main\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>