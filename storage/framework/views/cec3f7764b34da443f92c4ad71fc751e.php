                    ...
                    <a href="<?php echo e(route('shop.show', $product)); ?>" class="block">
                        <div class="relative">
                            ...
                            <div class="aspect-w-1 aspect-h-1 bg-gray-100 overflow-hidden">
                                <?php if($product->primaryImage && $product->primaryImage->first()): ?>
                                    <img src="<?php echo e(asset($product->primaryImage->first()->image_path)); ?>" 
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\habib\Downloads\laravel-ecom\laravel-ecom\resources\views/shop/category.blade.php ENDPATH**/ ?>