...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="text" name="barcode" id="barcode" value="<?php echo e(old('barcode', $product->barcode)); ?>"
                       class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <textarea name="description" id="description" rows="6" required
                          class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"><?php echo e(old('description', $product->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <textarea name="short_description" id="short_description" rows="3"
                          class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"><?php echo e(old('short_description', $product->short_description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="number" name="stock_alert_threshold" id="stock_alert_threshold" min="0"
                               class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                               value="<?php echo e(old('stock_alert_threshold', $product->stock_alert_threshold ?? 5)); ?>"
                    ...
                    <?php $__currentLoopData = $product->images->sortBy('sort_order'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="relative group">
                            ...
                            <div class="mt-2 flex items-center space-x-2">
                                <button type="button" onclick="setPrimary(<?php echo e($image->id); ?>)" 
                            ...
                            <input type="radio" name="primary_image" value="<?php echo e($image->id); ?>" 
                                   <?php echo e($image->is_primary ? 'checked' : ''); ?> class="hidden">
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" name="meta_title" id="meta_title" maxlength="255"
                               ...
                               placeholder="<?php echo e($product->name); ?> | Your Store">
                    ...
                    <div>
                        ...
                        <textarea name="meta_description" id="meta_description" rows="3" maxlength="500"
                                  class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                                  placeholder="<?php echo e(Str::limit(strip_tags($product->description), 160)); ?>"><?php echo e(old('meta_description', $product->meta_description)); ?></textarea>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\habib\Downloads\laravel-ecom\laravel-ecom\resources\views/admin/products/edit.blade.php ENDPATH**/ ?>