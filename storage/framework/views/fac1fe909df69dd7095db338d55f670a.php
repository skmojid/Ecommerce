    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4 sm:gap-0">
            <div class="text-center sm:text-left">
                ...
                <p class="text-lg text-gray-600 mt-1">(<?php echo e($products->total()); ?> items)</p>
            </div>
            
            <!-- View Toggle -->
            <div class="hidden lg:flex space-x-4">
                <button onclick="toggleView()" id="gridView" 
                        class="px-6 py-2.5 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 transition-colors">
                        ...
                        <div class="relative">
                            ...
                            <div class="aspect-w-1 aspect-h-1 bg-gray-100 overflow-hidden">
                                <?php if($product->primary_image): ?>
                                    <img src="<?php echo e(asset('storage/' . $product->primary_image->image_path)); ?>" 
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <div class="col-span-full text-center py-16">
                    <div class="bg-white rounded-lg shadow-sm p-12">
                        ...
                        <a href="<?php echo e(route('shop.index')); ?>" class="inline-flex items-center px-6 py-3 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-colors">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\habib\Downloads\laravel-ecom\laravel-ecom\resources\views/shop/index.blade.php ENDPATH**/ ?>